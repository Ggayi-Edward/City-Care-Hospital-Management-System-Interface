      ...
      <div className="flex-1 flex flex-col">
        ...
        <div className="px-8 pt-4 text-sm text-gray-600">
          <nav className="flex space-x-2 items-center">
            ...
            <span>/</span>
            <span className="text-gray-500">Reports Dashboard</span>
          </nav>
        </div>
        ...
        <div className="p-8 space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <ChartCard title="Patient Distribution by Age Group" />
            <ChartCard title="Bed Usage by Department" />
            <ChartCard title="Monthly Admission Trends" />
          </div>

          {/* Summary & Export */}
          <div className="flex justify-between items-center border-t pt-4 text-sm text-gray-600">
            <div>
              <strong>Total Patients:</strong> 1,250 | <strong>Total Beds:</strong> 175
            </div>
          ...
          <p className="text-xs text-right text-gray-500">
            Data updated as of 02:04 PM EAT, June 26, 2025
          </p>
        </div>
      </div>
    </div>
